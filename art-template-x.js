/*! art-template@4.13.1 for browser | https://github.com/aui/art-template */ ! function(e, t) {
    ...
    return function(e) {
        ...
        function i(e, t, n) {
            this.type = e, this.value = t, this.script = null,
                n ? (this.line = n.line + n.value.split(/\n/).length - 1, this.line === n.line
                ? this.start = n.end :
        ...
        var r = {
            ...
            use: function(e, t, n, i) {
                var o = this,
                    ...
                    p = n + u.shift(),
                    h = function(t, n) {
                        console.info((s.filename || "anonymous") + ":" + (e.line + 1) + ":" + (e.start + 1) + "\nTemplate upgrade: {{" + t + "}} -> {{" + n + "}}")
                    };
                switch ("#" === t && h("#value", "@value"), p) {
                    ...
                    case "repeat":
                        l = r._split(a), l.shift(), "as" === l[1] && (h("each object as value index", "each object value index"), l.splice(1, 1));
                        i = "$repeat(" + (l[0] || "$data1") + ",function(" + (l[1] || "$index") +  "){";
                        break;
                    case "/repeat":
                        i = "})";
                        break;
